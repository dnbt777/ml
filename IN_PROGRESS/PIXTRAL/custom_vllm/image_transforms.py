...
def normalize(
    ...
    if input_data_format == ChannelDimension.LAST:
        tdiff.capture(image, name="preprocessing_pre_norm.img", project="vllm")
        tdiff.capture(mean, name="preprocessing_pre_norm.mean", project="vllm")
        tdiff.capture(std, name="preprocessing_pre_norm.std", project="vllm")
        image = (image - mean) / std
    else:
        tdiff.capture(image, name="preprocessing_pre_norm.img", project="vllm")
        tdiff.capture(mean, name="preprocessing_pre_norm.mean", project="vllm")
