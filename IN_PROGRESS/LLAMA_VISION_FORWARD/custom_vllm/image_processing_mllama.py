    ...
    def preprocess(
        ...
        for images in images_list:
            ...
            for image in images:
                ...
                tdiff.capture(image, name="pre_preprocessing.img", project="vllm")
                ...
                tdiff.capture(image, name="preprocessing_post_resize.img", project="vllm")
                ...
                tdiff.capture(image, name="preprocessing_post_pad.img", project="vllm")
                ...
                tdiff.capture(image, name="preprocessing_post_rescale.img", project="vllm")
                ...
                #tdiff.capture(image, name="preprocessing_post_norm.img", project="vllm")

                num_tiles_height, num_tiles_width = aspect_ratio
                image = split_to_tiles(image, num_tiles_height, num_tiles_width)
                tdiff.capture(image, name="preprocessing_post_tilesplit.img", project="vllm") # done
