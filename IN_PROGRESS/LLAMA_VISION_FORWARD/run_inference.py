...
# TODO complete context masking by adding an attention mask to hide all empty context

answer = ""
context_window_size = 512 # if this is not done, it will recompile repeatedly forever at each new context window size
# inference loop
start = time.time()
for i in range(100):
